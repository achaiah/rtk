...
| Mistral Vibe | Planned ([#800](https://github.com/achaiah/rtk/issues/800)) | Pending upstream |
...
Support is blocked on upstream `BeforeToolCallback` ([mistral-vibe#531](https://github.com/mistralai/mistral-vibe/issues/531)). Tracked in [#800](https://github.com/achaiah/rtk/issues/800).
